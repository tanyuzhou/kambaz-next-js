  ...
  return (
    <>
      <Nav variant="pills" className="mb-3">
        ...
        <NavItem>
          <NavLink as={Link} href="/labs/lab4" id="wd-lab4-link" className={`nav-link ${pathname.endsWith("lab4") ? "active" : ""}`}>
            Lab 4
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink as={Link} href="/labs/lab5" id="wd-lab5-link" className={`nav-link ${pathname.endsWith("lab5") ? "active" : ""}`}>
            Lab 5
          </NavLink>
        </NavItem>
        <NavItem>
